...
const teamMembers = [
  { src: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&w=1200&q=80', alt: 'Advogada em retrato corporativo formal', name: 'Dra. Helena Barros', role: 'Contencioso estrategico e consultoria patrimonial', note: 'Atua em casos sensiveis com leitura tecnica profunda, postura firme e comunicacao segura para clientes e familias empresarias.' },
