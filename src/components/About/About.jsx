...
const teamMembers = [
  { src: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&w=1200&q=80', alt: 'Advogado em retrato corporativo formal', name: 'Dr. Jose Hernandes', role: 'Direito trabalhista e casos de CLT', note: 'Advogado com foco em causas trabalhistas, atuando em direitos previstos na CLT, rescisao, verbas, jornadas e defesa tecnica de trabalhadores com comunicacao clara e postura firme.' },
  { src: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=1200&q=80', alt: 'Advogado em retrato corporativo com terno', name: 'Dr. Caio Ferraz', role: 'Empresarial e societario', note: 'Advogado com atuacao em estrutura societaria, contratos e negociacoes estrategicas, oferecendo suporte seguro para decisoes empresariais, reorganizacoes e operacoes com alto impacto.' },
  { src: 'https://images.unsplash.com/photo-1573164713988-8665fc963095?auto=format&fit=crop&w=1200&q=80', alt: 'Advogada corporativa com documentos no escritorio', name: 'Dra. Marina Leal', role: 'Trabalhista e consultivo', note: 'Advogada com experiencia em consultoria trabalhista, prevencao de passivos e orientacao juridica para empresas e executivos, com comunicacao clara e conducao tecnica em temas sensiveis.' }
];
